...
extern "C" {
	JNIEXPORT jintArray JNICALL Java_com_aru_mispectacle_ASMModelActivity_FindFaceLandmarks(
		JNIEnv* env, jobject, jfloat ratioW, jfloat ratioH) 
	{
		...
		static const char* path = "/data/data/com.aru.mispectacle/app_stasmdata/testface.jpg";
